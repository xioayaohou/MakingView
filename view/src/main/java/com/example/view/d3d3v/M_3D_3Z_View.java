package com.example.view.d3d3v;
...
public class M_3D_3Z_View extends ViewGroup {
    ...
    public M_3D_3Z_View(Context context) {
        this(context,null);
    }

    public M_3D_3Z_View(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public M_3D_3Z_View(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mHeight1 = getMeasuredHeight();
        ...
        Log.e("aaa",mHeight+"    "+height+"     "+mHeight1);
