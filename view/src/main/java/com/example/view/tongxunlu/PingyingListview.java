...
public class PingyingListview extends ListView{
    ...
    public PingyingListview(Context context) {
        this(context, null);
    }

    public PingyingListview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PingyingListview(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                Log.e("aaa","dispatchTouchEvent:ACTION_MOVE ");

                if (Math.abs(getScrollVelocity()) > SNAP_VELOCITY
                        || (Math.abs(event.getX() - downX) > mTouchSlop && Math
                        .abs(event.getY() - downY) < mTouchSlop)) {

                    Log.e("aaa","dispatchTouchEvent:enter ");
                    isSlide = true;
