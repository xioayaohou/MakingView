...
public class CompassView extends BaseCompassView {
	...
	public CompassView(Context context, AttributeSet attrs, int defStyle) {
		...
		directionResources[0] ="北";
		directionResources[1] ="东";
		directionResources[2] ="南";
		directionResources[3] ="西";
	...
	private void initDistance(int position){
		degreeDistance = position * degreeDistanceRatio;
		directionDistance = position * directionDistanceRatio;
		barOuterDistance = position * barOuterDistanceRatio;
		barInnerDistance = position * barInnerDistanceRatio;
		crossDistance = position * crossDistanceRatio;
	}
